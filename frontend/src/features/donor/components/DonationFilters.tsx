...
import type { FoodCategory, FoodStatus, FoodFilters } from '../types/donor.types';

interface DonationFiltersProps {
  filters: FoodFilters;
  onChange: (newFilters: FoodFilters) => void;
  onReset: () => void;
}
    ...
    <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-xs space-y-3 mb-6">
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Search donation title or description..."
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            onChange={(e) =>
              onChange({
                ...filters,
                status: (e.target.value as FoodStatus) || undefined,
                page: 1,
              })
            }
