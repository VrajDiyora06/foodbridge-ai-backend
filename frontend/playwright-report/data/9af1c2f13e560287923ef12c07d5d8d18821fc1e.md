...
- Name: capture-screenshots.spec.ts >> Capture Real Application Screenshots (1920x1080) >> 9. receiver-dashboard.png
- Location: e2e\capture-screenshots.spec.ts:218:3
...
Call log:
  - navigating to "http://127.0.0.1:5173/receiver", waiting until "load"
