...
- Name: capture-screenshots.spec.ts >> Capture Real Application Screenshots (1920x1080) >> 15. admin-users.png
- Location: e2e\capture-screenshots.spec.ts:265:3
...
Call log:
  - navigating to "http://127.0.0.1:5173/admin/users", waiting until "load"
