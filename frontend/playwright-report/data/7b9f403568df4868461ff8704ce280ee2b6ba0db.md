...
- Name: receiver\receiver-flow.spec.ts >> Receiver Portal E2E Flow >> should navigate to available food catalog page
- Location: e2e\receiver\receiver-flow.spec.ts:8:3
...
Call log:
  - navigating to "http://127.0.0.1:5173/receiver/available", waiting until "load"
