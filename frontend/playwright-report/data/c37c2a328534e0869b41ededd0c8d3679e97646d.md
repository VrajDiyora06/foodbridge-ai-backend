...
- Name: capture-screenshots.spec.ts >> Capture Real Application Screenshots (1920x1080) >> 6. my-donations.png
- Location: e2e\capture-screenshots.spec.ts:197:3
...
Call log:
  - navigating to "http://127.0.0.1:5173/donor/donations", waiting until "load"
