...
- Name: capture-screenshots.spec.ts >> Capture Real Application Screenshots (1920x1080) >> 13. map.png
- Location: e2e\capture-screenshots.spec.ts:251:3
...
Call log:
  - navigating to "http://127.0.0.1:5173/map/nearby", waiting until "load"
