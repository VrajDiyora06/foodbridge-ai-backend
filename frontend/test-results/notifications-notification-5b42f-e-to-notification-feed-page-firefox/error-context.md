...
- Name: notifications\notification-flow.spec.ts >> Notification System E2E Flow >> should navigate to notification feed page
- Location: e2e\notifications\notification-flow.spec.ts:4:3
...
Call log:
  - navigating to "http://127.0.0.1:5173/notifications", waiting until "load"
