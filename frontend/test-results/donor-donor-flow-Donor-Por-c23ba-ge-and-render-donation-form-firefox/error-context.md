...
- Name: donor\donor-flow.spec.ts >> Donor Portal E2E Flow >> should navigate to create donation page and render donation form
- Location: e2e\donor\donor-flow.spec.ts:8:3
...
Call log:
  - navigating to "http://127.0.0.1:5173/donor/donate", waiting until "load"
