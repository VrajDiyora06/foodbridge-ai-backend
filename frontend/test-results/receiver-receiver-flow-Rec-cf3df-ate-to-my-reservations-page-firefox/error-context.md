...
- Name: receiver\receiver-flow.spec.ts >> Receiver Portal E2E Flow >> should navigate to my reservations page
- Location: e2e\receiver\receiver-flow.spec.ts:12:3
...
Call log:
  - navigating to "http://127.0.0.1:5173/receiver/reservations", waiting until "load"
